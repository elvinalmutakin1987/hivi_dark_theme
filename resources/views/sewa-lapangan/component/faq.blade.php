<div class="page-title faqs">
    <div class="themesflat-container">
        <div class="row">
            <div class="col-12">
                <h1 data-wow-delay="0s" class="wow fadeInUp heading text-center fc-black">FAQ</h1>
                ...
                <div class="flat-accordion2">
                    ...
                    <div data-wow-delay="0s" class="wow fadeInUp flat-toggle2">
                        ...
                        <div class="toggle-content" style="display: block;">
                            <p>Blockchain is a shared, immutable ledger that facilitates the process of recording
                                ...
                                network, reducing risk and cutting costs for all involved</p>
                        </div>
                    </div>
                    <div data-wow-delay="0s" class="wow fadeInUp flat-toggle2">
                    ...
                    <div data-wow-delay="0s" class="wow fadeInUp flat-toggle2">
                        <h6 class="toggle-title">Where can I learn more about cryptocurrencies, NFTs, and blockchain?
                        </h6>
                        <div class="toggle-content">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
